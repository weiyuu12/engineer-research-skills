...
| `image plate + quant` | Simulation snapshots, field maps, experimental photos, spatial overlays, segmentation, or device images lead the evidence | Image plate or representative image | Scale bars/physical units, overlays, crops, quantification |
...
1. Establish the system: method, operating condition, device, model, or experimental design.
...
colors, symbols, workflow direction, condition classes, and scale. Reuse that vocabulary
...
- Are representative images, snapshots, or field maps quantified and traceable to raw files?
