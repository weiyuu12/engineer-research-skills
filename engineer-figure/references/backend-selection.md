...
NumPy-like data, or custom layout, and do not infer R just because the task uses
heatmaps or multi-panel statistics.
...
|---|---|
| The user brings R scripts, RData/RDS, tidy data frames, model summary tables, or ggplot templates | The data pipeline is already Python, NumPy/Pandas arrays, PyTorch/TensorFlow outputs, image arrays, or simulation output |
| The target plot is `ggplot2`, `patchwork`, `ComplexHeatmap`, `circlize`, or tidyverse-heavy | The target plot needs low-level custom layout, Matplotlib patches, image plates, subplot mosaics, or custom drawing primitives |
...
| Heatmap annotations are layered and table-like | Image panels and quantitative panels need tight pixel/axis control |
...
- Forest/interval plots: `forestplot`, `ggplot2`
- Engineering heatmaps: `ComplexHeatmap`, `circlize`, `ggplot2`
...
layered annotation and patchwork assembly. I will still keep the export contract
