...
neural-operator, or inverse-design figures, use `engineering-reference-atlas.md` first.
Use this file only for broad Nature page rhythm, panel hierarchy, and cross-cutting
editorial rules.
